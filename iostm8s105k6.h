...
#ifndef __IOSTM8S105K6_H__
#define __IOSTM8S105K6_H__
...
unsigned char UART2_SR; //0x5240 __READ_WRITE
__BITS_UART2_SR UART2_SR_bit;

/* UART2 data register */
//__IO_REG8    (UART2_DR,    0x5241, __READ_WRITE);
unsigned char UART2_DR; //0x5241 __READ_WRITE
/* UART2 baud rate register 1 */
//__IO_REG8    (UART2_BRR1,  0x5242, __READ_WRITE);
unsigned char UART2_BRR1; //0x5242 __READ_WRITE
/* UART2 baud rate register 2 */
//__IO_REG8    (UART2_BRR2,  0x5243, __READ_WRITE);
unsigned char UART2_BRR2; //0x5243 __READ_WRITE
...
unsigned char UART2_CR1; //0x5244 __READ_WRITE
__BITS_UART2_CR1 UART2_CR1_bit;
...
unsigned char UART2_CR2; //0x5245 __READ_WRITE
__BITS_UART2_CR2 UART2_CR2_bit;
...
unsigned char UART2_CR3; //0x5246 __READ_WRITE
__BITS_UART2_CR3 UART2_CR3_bit;
...
unsigned char UART2_CR4; //0x5247 __READ_WRITE
__BITS_UART2_CR4 UART2_CR4_bit;
...
unsigned char UART2_CR6; //0x5249 __READ_WRITE
__BITS_UART2_CR6 UART2_CR6_bit;

/* UART2 guard time register */
//__IO_REG8    (UART2_GTR,   0x524A, __READ_WRITE);
unsigned char UART2_GTR; //0x524A __READ_WRITE
/* UART2 prescaler register */
//__IO_REG8    (UART2_PSCR,  0x524B, __READ_WRITE);
unsigned char UART2_PSCR; //0x524B __READ_WRITE
