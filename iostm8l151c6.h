...
#ifndef __IOSTM8L151C6_H__
#define __IOSTM8L151C6_H__
...
unsigned char DAC_CR1; //0x5380 __READ_WRITE
__BITS_DAC_CR1 DAC_CR1_bit;
...
unsigned char DAC_CR2; //0x5381 __READ_WRITE
__BITS_DAC_CR2 DAC_CR2_bit;
...
unsigned char DAC_SWTRIGR; //0x5384 __READ
__BITS_DAC_SWTRIGR DAC_SWTRIGR_bit;
...
unsigned char DAC_LDHRL; //0x538D __READ_WRITE
__BITS_DAC_LDHRL DAC_LDHRL_bit;

/* DAC 8-bit data holding register */
//__IO_REG8    (DAC_DHR8,    0x5390, __READ_WRITE);
unsigned char DAC_DHR8; //0x5390 __READ_WRITE
