...
#ifndef __IOSTM8L162R8_H__
#define __IOSTM8L162R8_H__
 ...
 *-----------------------------------------------------------------------*/
/* AES control register 0x00 */
#ifdef __IAR_SYSTEMS_ICC__
typedef struct
{
  unsigned char EN          : 1;
  unsigned char MODE        : 2;
  unsigned char CCFC        : 1;
  unsigned char ERRFC       : 1;
  unsigned char CCIE        : 1;
  unsigned char ERRIE       : 1;
  unsigned char DMAEN       : 1;
} __BITS_AES_CR;
#endif
//__IO_REG8_BIT(AES_CR,      0x51D0, __READ_WRITE, __BITS_AES_CR);
unsigned char AES_CR; //0x51D0 __READ_WRITE
__BITS_AES_CR AES_CR_bit;

/* AES status register 0x00 */
#ifdef __IAR_SYSTEMS_ICC__
typedef struct
{
  unsigned char CCF         : 1;
  unsigned char RDERR       : 1;
  unsigned char WRERR       : 1;
} __BITS_AES_SR;
#endif
//__IO_REG8_BIT(AES_SR,      0x51D1, __READ, __BITS_AES_SR);
unsigned char AES_SR; //0x51D1 __READ
__BITS_AES_SR AES_SR_bit;

/* AES data input register 0x00 */
//__IO_REG8    (AES_DINR,    0x51D2, __READ_WRITE);
unsigned char AES_DINR; //0x51D2 __READ_WRITE
/* AES data output register 0x00 */
//__IO_REG8    (AES_DOUTR,   0x51D3, __READ);
unsigned char AES_DOUTR; //0x51D3 __READ
...
#define AES_CR_EN                AES_CR_bit.EN
#define AES_CR_MODE              AES_CR_bit.MODE
#define AES_CR_CCFC              AES_CR_bit.CCFC
#define AES_CR_ERRFC             AES_CR_bit.ERRFC
#define AES_CR_CCIE              AES_CR_bit.CCIE
#define AES_CR_ERRIE             AES_CR_bit.ERRIE
#define AES_CR_DMAEN             AES_CR_bit.DMAEN

#define AES_SR_CCF               AES_SR_bit.CCF
#define AES_SR_RDERR             AES_SR_bit.RDERR
#define AES_SR_WRERR             AES_SR_bit.WRERR
 ...
 *      AES bit masks
 *-----------------------------------------------------------------------*/
#define MASK_AES_CR_EN           0x01
#define MASK_AES_CR_MODE         0x06
#define MASK_AES_CR_CCFC         0x08
#define MASK_AES_CR_ERRFC        0x10
#define MASK_AES_CR_CCIE         0x20
#define MASK_AES_CR_ERRIE        0x40
#define MASK_AES_CR_DMAEN        0x80

#define MASK_AES_SR_CCF          0x01
#define MASK_AES_SR_RDERR        0x02
#define MASK_AES_SR_WRERR        0x04
