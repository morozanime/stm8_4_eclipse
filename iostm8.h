...
#ifndef __IOSTM8S208MB_H__
#define __IOSTM8S208MB_H__
...
//__IO_REG8    (FLASH_FPR,   0x505D, __READ_WRITE);
unsigned char FLASH_FPR; //0x505D __READ_WRITE
/* Flash complementary protection register */
//__IO_REG8    (FLASH_NFPR,  0x505E, __READ_WRITE);
unsigned char FLASH_NFPR; //0x505E __READ_WRITE
...
//__IO_REG8    (AWU_APR,     0x50F1, __READ_WRITE);
