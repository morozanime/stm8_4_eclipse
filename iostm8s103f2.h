...
#ifndef __IOSTM8S103F2_H__
#define __IOSTM8S103F2_H__
...
unsigned char TIM2_IER; //0x5303 __READ_WRITE
...
unsigned char TIM2_SR1; //0x5304 __READ_WRITE
...
unsigned char TIM2_SR2; //0x5305 __READ_WRITE
...
unsigned char TIM2_EGR; //0x5306 __WRITE
...
unsigned char TIM2_CCMR1; //0x5307 __READ_WRITE
...
unsigned char TIM2_CCMR2; //0x5308 __READ_WRITE
...
unsigned char TIM2_CCMR3; //0x5309 __READ_WRITE
...
unsigned char TIM2_CCER1; //0x530A __READ_WRITE
...
unsigned char TIM2_CCER2; //0x530B __READ_WRITE
__BITS_TIM2_CCER2 TIM2_CCER2_bit;

/* TIM2 counter high */
//__IO_REG8    (TIM2_CNTRH,  0x530C, __READ_WRITE);
unsigned char TIM2_CNTRH; //0x530C __READ_WRITE
/* TIM2 counter low */
//__IO_REG8    (TIM2_CNTRL,  0x530D, __READ_WRITE);
unsigned char TIM2_CNTRL; //0x530D __READ_WRITE
...
unsigned char TIM4_IER; //0x5343 __READ_WRITE
...
unsigned char TIM4_SR; //0x5344 __READ_WRITE
...
unsigned char TIM4_EGR; //0x5345 __WRITE
__BITS_TIM4_EGR TIM4_EGR_bit;

/* TIM4 counter */
//__IO_REG8    (TIM4_CNTR,   0x5346, __READ_WRITE);
unsigned char TIM4_CNTR; //0x5346 __READ_WRITE
...
unsigned char TIM4_PSCR; //0x5347 __READ_WRITE
__BITS_TIM4_PSCR TIM4_PSCR_bit;

/* TIM4 auto-reload register */
//__IO_REG8    (TIM4_ARR,    0x5348, __READ_WRITE);
unsigned char TIM4_ARR; //0x5348 __READ_WRITE
...
__BITS_ADC_AWSRL ADC_AWSRL_bit;
...
__BITS_ADC_AWCRL ADC_AWCRL_bit;
